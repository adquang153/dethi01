...
<div>
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
      	<h4 class="modal-title">Thống kê ĐTB</h6>
      </div>
      <div class="modal-body">
      	<table class="table table-border">
      		<tr>
      		...
      		<tr>
      		<% tkbean dtb = (tkbean)request.getAttribute("dtb"); %>
      			<td><%=(dtb!=null?dtb.getMatv():"") %></td>
      			<td><%=(dtb!=null?dtb.getHttv():"") %></td>
      			<td><%=(dtb!=null?dtb.getDtb():"") %></td>
      		</tr>
      	</table>
      </div>
      <div class="modal-footer">
